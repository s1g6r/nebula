import { Moon, Sun, Network, FileText, CalendarDays, Sparkles } from 'lucide-react';
...
export function TopBar({ view, onViewChange, theme, onToggleTheme, onOpenToday }: TopBarProps) {
  return (
    <div className="h-13 shrink-0 flex items-center gap-3 px-4 border-b border-black/10 dark:border-white/10 bg-white/70 dark:bg-[#0b0e1a]/70 backdrop-blur-sm">
